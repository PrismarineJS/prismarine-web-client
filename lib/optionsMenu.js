  ...
  render () {
    ...
    <div class="menu-box">
      <h2 class="title">Options Menu</h2>
        ...
        <div class="spacev"></div>
        <h2 class="subtitle">Mouse Sensitivity
        <legacy-button btn-width="100%">++</legacy-button><legacy-text-field field-width="100%" field-label="Sensitivity" field-id="Sensitivity" field-value="${window.settings.mouseSensXValue}" @input=${e => { window.settings.mouseSensXValue = e.target.value; window.settings.mouseSensYValue = e.target.value; }}></legacy-text-field><legacy-button btn-width="100%">--</legacy-button>
    </div>
    `
  }

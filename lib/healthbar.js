...
.health.absorption > * { display: none; }
...
.health > .half {
  ...
  <div class="health" data-value="20">${'<span></span>'.repeat(10)}</div>
  <div class="health absorption" data-value="0">${'<span></span>'.repeat(10)}</div>
</div>`
  }
}

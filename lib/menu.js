...
const res = req('GET', '/config.json')
const config = JSON.parse(res.getBody('utf8'))
console.log(config)
require('./github_link')
  ...
  render () {
    ...
    <div class="login-box">
      ...
      <form>
        ...
        <div class="ip-box">
          <input id="serverip" type="text" name="" required="" value="${
            this.server
          }" @input=${(e) => {
      this.server = e.target.value
        ...
        <div class="port-box">
          <input id="port" type="text" name="" required="" value="${
            this.serverport
          }" @input=${(e) => {
      this.serverport = e.target.value
        ...
        <form>
          <div class="ip-with-port">
        <div class="ip-box">
          <input id="proxy" type="text" name="" required="" value="${
            this.proxy
          }" @input=${(e) => {
      ...
      this.proxyport = e.target.value
        ...
        <form>
        <div class="user-box">
          <input id="username" type="text" name="" required="" value="${
            this.username
          }" @input=${(e) => {
      this.username = e.target.value
        ...
        <a href="#" @click=${() => this.dispatchConnect()}>
          <span></span>
          <span></span>
          <span></span>
          <span></span>

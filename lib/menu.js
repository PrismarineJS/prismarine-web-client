...
class PrismarineMenu extends LitElement {
  ...
  render () {
    ...
    <div class="login-box">
      ...
      <h3 class="about-text">Prismarine Web Client is a 3rd party minecraft client which runs in the browser. It's still WIP, so expect a few glitches. It runs on mineflayer and mineflayer-viewer.<h3>
      </center>
      <form>

...
class PrismarineMenu extends LitElement {
  ...
  render () {
    ...
    <div class="login-box">
      ...
      <form>
        <div class="user-box">
          <input id="server" type="text" value="${this.server}" @input=${e => { this.server = e.target.value }} name="" required="">
        ...
        <div class="user-box">
          <input id="password" type="password" name="" required="" @input=${e => { this.paswword = e.target.value }}>

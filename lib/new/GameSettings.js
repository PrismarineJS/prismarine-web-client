...
export default class GameSettings {
  constructor (mcIn) {
    ...
    this.mouseSensXValue = 0.005;
    this.mouseSensYValue = 0.005;
    this.loadOptions()
  }
    ...
    if (localStorage.getItem('Options')) {
      ...
      for (const s of optionsData.keySet()) {
        ...
        try {
          ...
          if (s == 'mouseSensXValue') this.mouseSensXValue = parseFloat(s1)
          if (s == 'mouseSensYValue') this.mouseSensYValue = parseFloat(s1)
  ...
  saveOptions () {
    ...
    try {
      ...
      lsoptions.addLine('mouseSensXValue:' + this.mouseSensXValue)
      lsoptions.addLine('mouseSensYValue:' + this.mouseSensYValue)
      lsoptions.saveToLS()
    } catch (e) {

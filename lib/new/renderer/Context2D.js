...
export default class Context2D {
  ...
  static fillRect (x, y, width, height, color = 'white') {
  ...
  /** @deprecated */
  static drawText(text, x, y, color = 'white', shadow = true) {
    if (text !== null && text !== undefined) {
      context.font = 'normal 10px minecraft'
      if(shadow) {
  ...
  /** @deprecated */
  static drawCenteredText(text, x, y, color = 'white', shadow = true) {
    Context2D.drawText(text, x - context.measureText(text).width / 2, y, color, shadow);
  }
}

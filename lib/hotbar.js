...
class HotBar extends LitElement {
  ...
  async reloadHotbar () {
    const slotsToReload = {
      0: this.bot.inventory.hotbarStart,
      1: this.bot.inventory.hotbarStart + 1,
      2: this.bot.inventory.hotbarStart + 2,
      3: this.bot.inventory.hotbarStart + 3,
      4: this.bot.inventory.hotbarStart + 4,
      5: this.bot.inventory.hotbarStart + 5,
      6: this.bot.inventory.hotbarStart + 6,
      7: this.bot.inventory.hotbarStart + 7,
      8: this.bot.inventory.hotbarStart + 8,
      offhand: this.bot.getEquipmentDestSlot('off-hand')
    }
    Object.keys(slotsToReload).forEach(key => {
      const item = this.bot.inventory.slots[slotsToReload[key]]
  ...
  static get styles () {
    ...
    #hotbar-image {
      ...
      height: calc(256px * 4);
      width: calc(256px * 4);
      transform: translate(-35.555%, -8.594%);
      clip-path: inset(0% 28.906% 91.406% 0%);
    }
    ...
    #hotbar-offhand-image {
      ...
      height: calc(256px * 4);
      width: calc(256px * 4);
      transform: translate(-58.5%, -17.5%);
      clip-path: inset(9% 82% 82.5% 9.5%);
    }
    ...
    #hotbar-offhand-wrapper {
      ...
      height: calc(256px * 4);
      width: calc(256px * 4);
      transform: translate(-48.33%, -9%);
      clip-path: inset(0% 91% 91% 0%);
    }

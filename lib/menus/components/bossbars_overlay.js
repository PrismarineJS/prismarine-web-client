...
class BossBars extends LitElement {
  ...
  setTitle (bar) {
    if (bar.bossBar.title.text) bar.title.innerText = bar.bossBar.title.text
      ...
      if (bar.bossBar.title.translate === 'entity.minecraft.ender_dragon') { bar.title.innerText = 'Ender Dragon' } else if (bar.bossBar.title.translate === 'entity.minecraft.wither') { bar.title.innerText = 'Wither' } else { bar.title.innerText = 'Unknown Entity' }
    }
  }

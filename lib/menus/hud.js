  ...
  render () {
    return html`
      ...
      <div class="mobile-controls-left" id="mobile-left">
        <button class="mobile-control-forward" @touchstart=${(e) => {
          e.stopPropagation()
        ...
        <button class="mobile-control-back" @touchstart=${(e) => {
          e.stopPropagation()
        ...
        <button class="mobile-control-left" @touchstart=${(e) => {
          e.stopPropagation()
        ...
        <button class="mobile-control-right" @touchstart=${(e) => {
          e.stopPropagation()
        ...
        <button class="mobile-control-sneak" @dblclick=${(e) => {
          ...
          bot.setControlState('sneak', b)
        }}></button>
      </div>
      <div class="mobile-controls-right" id="mobile-right">
        <button class="mobile-control-jump" @touchstart=${(e) => {
          e.stopPropagation()

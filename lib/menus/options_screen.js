  ...
  render () {
    return html`
      ...
      <main>
        ...
        <div class="wrapper">
          <pmui-slider pmui-label="Render Distance" pmui-value="${this.renderDistance}" pmui-disabled="${this.isInsideWorld ? 'Can be changed only from main menu for now' : undefined}" pmui-min="2" pmui-max="6" pmui-type=" chunks" @input=${(e) => {
